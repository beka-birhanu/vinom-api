...
import (
	...
	pb_game "github.com/beka-birhanu/vinom-api/game/pb_encoder"
	...
	pb_udp "github.com/beka-birhanu/vinom-api/udp/pb_encoder"
...
func main() {
	...
	gameServer, err := game.New(maz, []game.Player{player1, player2}, game_encoder)
	if err != nil {
		return
	}

...
type ClientSocketManager struct {
	...
	encoder            Encoder            // Encoder is an implementation of Encoder used to encode and decode messages.
	...
	asymmCrypto        Asymmetric         // AsymmCrypto is an implementation of asymmetric encryption.
	serverAsymmPubKey  []byte             // ServerAsymmPubKey is the server's public key for asymmetric encryption.
	symmCrypto         Symmetric          // SymmCrypto is an implementation of symmetric encryption.
...
type ClientConfig struct {
	...
	Encoder            Encoder            // Encoder is an implementation of Encoder to encode and decode messages.
	AsymmCrypto        Asymmetric         // AsymmCrypto is an implementation of asymmetric encryption.
	ServerAsymmPubKey  []byte             // ServerAsymmPubKey is the server's public key for asymmetric encryption.
	SymmCrypto         Symmetric          // SymmCrypto is an implementation of symmetric encryption.
	ClientSymmKey      []byte             // ClientSymmKey is the client's symmetric encryption key.
